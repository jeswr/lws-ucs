...
1. **<dfn id="req-access-request-handling">Access Request Handling</dfn>** <span class="informative">(`REQ-access-request-handling` — Functional · Must have)</span>
...
1. **<dfn id="req-resource-crud">Adding, Updating, Deleting Resources in Storage</dfn>** <span class="informative">(`REQ-resource-crud` — Functional · Must have)</span>
...
1. **<dfn id="req-authentication-mechanisms">Authentication Mechanisms</dfn>** <span class="informative">(`REQ-authentication-mechanisms` — Functional, Security · Must have)</span>
...
1. **<dfn id="req-cors-browser-access">Browser Access from Foreign Origins</dfn>** <span class="informative">(`REQ-cors-browser-access` — Interoperability · Must have)</span>
...
1. **<dfn id="req-binary-fidelity">Byte-Exact Non-RDF Resource Fidelity</dfn>** <span class="informative">(`REQ-binary-fidelity` — Functional, Interoperability · Must have)</span>
...
1. **<dfn id="req-conditional-requests">Conditional Requests and Optimistic Concurrency</dfn>** <span class="informative">(`REQ-conditional-requests` — Functional, Interoperability · Must have)</span>
...
1. **<dfn id="req-consent-based-sharing">Consent-Based Data Sharing</dfn>** <span class="informative">(`REQ-consent-based-sharing` — Privacy · Must have)</span>
...
1. **<dfn id="req-control-of-storages">Control of Storages</dfn>** <span class="informative">(`REQ-control-of-storages` — Functional · Must have)</span>
...
1. **<dfn id="req-data-sharing">Data Sharing</dfn>** <span class="informative">(`REQ-data-sharing` — Functional · Must have)</span>
...
1. **<dfn id="req-delegation-of-access-rights">Delegation of Access Rights</dfn>** <span class="informative">(`REQ-delegation-of-access-rights` — Functional · Must have)</span>
...
1. **<dfn id="req-secure-defaults">Fail-Closed Creation Semantics</dfn>** <span class="informative">(`REQ-secure-defaults` — Security · Must have)</span>
...
1. **<dfn id="req-globally-unique-identifiers">Globally Unique Identifiers</dfn>** <span class="informative">(`REQ-globally-unique-identifiers` — Functional, Interoperability · Must have)</span>
...
1. **<dfn id="req-group-access-control">Group-Based Access Control</dfn>** <span class="informative">(`REQ-group-access-control` — Functional · Must have)</span>
...
1. **<dfn id="req-scoped-access">Least-Privilege Scoped Credentials</dfn>** <span class="informative">(`REQ-scoped-access` — Security · Must have)</span>
...
1. **<dfn id="req-non-leaky-discovery">Non-Leaky Discovery</dfn>** <span class="informative">(`REQ-non-leaky-discovery` — Privacy, Security · Must have)</span>
...
1. **<dfn id="req-offline-sync">Offline Access and Synchronization</dfn>** <span class="informative">(`REQ-offline-sync` — Functional · Must have)</span>
...
1. **<dfn id="req-performance-scalability">Performance and Scalability</dfn>** <span class="informative">(`REQ-performance-scalability` — Non-functional · Must have)</span>
...
1. **<dfn id="req-self-descriptive-apis">Self-Descriptive and Discoverable APIs</dfn>** <span class="informative">(`REQ-self-descriptive-apis` — Functional, Interoperability · Must have)</span>
...
1. **<dfn id="req-serialization-format">Serialization Format</dfn>** <span class="informative">(`REQ-serialization-format` — Interoperability · Must have)</span>
...
1. **<dfn id="req-storage-portability">Storage Portability</dfn>** <span class="informative">(`REQ-storage-portability` — Interoperability · Must have)</span>
...
1. **<dfn id="req-change-notifications">Subscribing to Resource Changes (Notifications)</dfn>** <span class="informative">(`REQ-change-notifications` — Functional · Must have)</span>
...
1. **<dfn id="req-trusted-identity-providers">Trusted Identity Providers</dfn>** <span class="informative">(`REQ-trusted-identity-providers` — Security · Must have)</span>
...
1. **<dfn id="req-write-attribution">Attribution of Writes</dfn>** <span class="informative">(`REQ-write-attribution` — Functional, Security · Should have)</span>
...
1. **<dfn id="req-auditable-trail">Auditable Trail</dfn>** <span class="informative">(`REQ-auditable-trail` — Security · Should have)</span>
...
1. **<dfn id="req-authorization-enumeration">Authorization Enumeration</dfn>** <span class="informative">(`REQ-authorization-enumeration` — Functional, Security · Should have)</span>
...
1. **<dfn id="req-contextual-access-control">Contextual Access Control</dfn>** <span class="informative">(`REQ-contextual-access-control` — Functional, Security · Should have)</span>
...
1. **<dfn id="req-data-integrity-verification">Data Integrity Verification</dfn>** <span class="informative">(`REQ-data-integrity-verification` — Security · Should have)</span>
...
1. **<dfn id="req-app-data-registry">Data Location Registry</dfn>** <span class="informative">(`REQ-app-data-registry` — Functional, Interoperability, Privacy · Should have)</span>
...
1. **<dfn id="req-delegation-of-control">Delegation of Control</dfn>** <span class="informative">(`REQ-delegation-of-control` — Functional · Should have)</span>
...
1. **<dfn id="req-deletion-signaling">Deletion and Move Signaling</dfn>** <span class="informative">(`REQ-deletion-signaling` — Functional · Should have)</span>
...
1. **<dfn id="req-paired-metadata">Descriptive Metadata Without Touching the Resource</dfn>** <span class="informative">(`REQ-paired-metadata` — Functional · Should have)</span>
...
1. **<dfn id="req-permission-introspection">Effective-Permission Introspection</dfn>** <span class="informative">(`REQ-permission-introspection` — Functional · Should have)</span>
...
1. **<dfn id="req-e2e-encryption">End-to-End Encryption</dfn>** <span class="informative">(`REQ-e2e-encryption` — Privacy, Security · Should have)</span>
...
1. **<dfn id="req-inbox">Inbox (Notifications)</dfn>** <span class="informative">(`REQ-inbox` — Functional · Should have)</span>
...
1. **<dfn id="req-legal-basis-enforcement">Legal Basis Enforcement</dfn>** <span class="informative">(`REQ-legal-basis-enforcement` — Privacy · Should have)</span>
...
1. **<dfn id="req-protocol-decoupling">Loose Coupling of Underlying Protocols</dfn>** <span class="informative">(`REQ-protocol-decoupling` — Interoperability · Should have)</span>
...
1. **<dfn id="req-range-requests">Partial-Content Reads</dfn>** <span class="informative">(`REQ-range-requests` — Functional · Should have)</span>
...
1. **<dfn id="req-personal-data-projection">Personal Data Projection</dfn>** <span class="informative">(`REQ-personal-data-projection` — Interoperability · Should have)</span>
...
1. **<dfn id="req-profile-management">Profile Management</dfn>** <span class="informative">(`REQ-profile-management` — Functional, Privacy · Should have)</span>
...
1. **<dfn id="req-rate-limit-signaling">Rate-Limit Signaling</dfn>** <span class="informative">(`REQ-rate-limit-signaling` — Non-functional · Should have)</span>
...
1. **<dfn id="req-resource-versioning">Resource Versioning</dfn>** <span class="informative">(`REQ-resource-versioning` — Functional · Should have)</span>
...
1. **<dfn id="req-resumable-uploads">Resumable Large Data Transfers</dfn>** <span class="informative">(`REQ-resumable-uploads` — Functional · Should have)</span>
...
1. **<dfn id="req-search-and-query">Search and Query</dfn>** <span class="informative">(`REQ-search-and-query` — Functional · Should have)</span>
    ...
    *Sources:* [#45](https://github.com/w3c/lws-ucs/issues/45), [#152](https://github.com/w3c/lws-ucs/issues/152)
    ...
    1. **<dfn id="req-federated-query-joins">Federated Query Joins</dfn>** <span class="informative">(`REQ-federated-query-joins` — Functional · Could have)</span>
    ...
    1. **<dfn id="req-metadata-query">Metadata Query</dfn>** <span class="informative">(`REQ-metadata-query` — Functional · Should have)</span>
    ...
    1. **<dfn id="req-paginate-filter-sort">Pagination, Filtering and Sorting</dfn>** <span class="informative">(`REQ-paginate-filter-sort` — Functional, Non-functional · Should have)</span>
    ...
    1. **<dfn id="req-pod-level-query">Pod-Level Query</dfn>** <span class="informative">(`REQ-pod-level-query` — Functional · Should have)</span>
    ...
    1. **<dfn id="req-query-other-pods">Query Other Storages</dfn>** <span class="informative">(`REQ-query-other-pods` — Functional · Should have)</span>
    ...
    1. **<dfn id="req-resource-level-query">Resource-Level Query</dfn>** <span class="informative">(`REQ-resource-level-query` — Functional · Should have)</span>
...
1. **<dfn id="req-server-to-server-auth">Server-to-Server Authentication</dfn>** <span class="informative">(`REQ-server-to-server-auth` — Functional, Security · Should have)</span>
...
1. **<dfn id="req-silent-reauth">Silent Session Continuation</dfn>** <span class="informative">(`REQ-silent-reauth` — Functional, Security · Should have)</span>
...
1. **<dfn id="req-app-identity">Stable, Verifiable Application Identity</dfn>** <span class="informative">(`REQ-app-identity` — Interoperability, Security · Should have)</span>
...
1. **<dfn id="req-structured-errors">Structured, Machine-Actionable Errors</dfn>** <span class="informative">(`REQ-structured-errors` — Functional, Interoperability · Should have)</span>
...
1. **<dfn id="req-transfer-of-control">Transfer of Control</dfn>** <span class="informative">(`REQ-transfer-of-control` — Functional · Should have)</span>
...
1. **<dfn id="req-service-providers">Use of Service Providers</dfn>** <span class="informative">(`REQ-service-providers` — Functional · Should have)</span>
...
1. **<dfn id="req-external-identifier-access">Access to Data About External Identifiers</dfn>** <span class="informative">(`REQ-external-identifier-access` — Functional, Interoperability · Could have)</span>
...
1. **<dfn id="req-atomic-batch">Atomic Multi-Resource Operations</dfn>** <span class="informative">(`REQ-atomic-batch` — Functional · Could have)</span>
...
1. **<dfn id="req-collaborative-editing">Collaborative Editing</dfn>** <span class="informative">(`REQ-collaborative-editing` — Functional · Could have)</span>
...
1. **<dfn id="req-extension-endpoints">Discoverable Extension Endpoints</dfn>** <span class="informative">(`REQ-extension-endpoints` — Functional, Interoperability · Could have)</span>
...
1. **<dfn id="req-federated-queries">Federated Data Queries</dfn>** <span class="informative">(`REQ-federated-queries` — Functional · Could have)</span>
...
1. **<dfn id="req-immutable-snapshots">Immutable Resource Snapshots</dfn>** <span class="informative">(`REQ-immutable-snapshots` — Functional, Security · Could have)</span>
...
1. **<dfn id="req-indexing-control">Indexing Control</dfn>** <span class="informative">(`REQ-indexing-control` — Functional · Could have)</span>
...
1. **<dfn id="req-profile-interaction-ui">Profile Interaction UI</dfn>** <span class="informative">(`REQ-profile-interaction-ui` — Functional, Interoperability · Could have)</span>
...
1. **<dfn id="req-pseudonymity">Pseudonymous Identifiers</dfn>** <span class="informative">(`REQ-pseudonymity` — Privacy · Could have)</span>
...
1. **<dfn id="req-scalable-storage-management">Scalable Storage Management</dfn>** <span class="informative">(`REQ-scalable-storage-management` — Functional, Non-functional · Could have)</span>
...
1. **<dfn id="req-website-publication">Self-Describing Website Publication</dfn>** <span class="informative">(`REQ-website-publication` — Functional · Could have)</span>
...
1. **<dfn id="req-rename-move">Server-Side Rename and Move</dfn>** <span class="informative">(`REQ-rename-move` — Functional · Could have)</span>
...
1. **<dfn id="req-write-validation">Server-Side Write Validation</dfn>** <span class="informative">(`REQ-write-validation` — Functional, Security · Could have)</span>
...
1. **<dfn id="req-timeseries">Timeseries Data Support</dfn>** <span class="informative">(`REQ-timeseries` — Functional · Could have)</span>
...
1. **<dfn id="req-quota-discovery">Usage and Quota Discovery</dfn>** <span class="informative">(`REQ-quota-discovery` — Functional · Could have)</span>
...
1. **<dfn id="req-usage-control">Usage Control Policies</dfn>** <span class="informative">(`REQ-usage-control` — Functional, Privacy · Could have)</span>
...
1. **<dfn id="req-verified-references">Verified References to External Resources</dfn>** <span class="informative">(`REQ-verified-references` — Functional, Security · Could have)</span>
...
1. **<dfn id="req-view-based-sharing">View-Based Data Sharing</dfn>** <span class="informative">(`REQ-view-based-sharing` — Functional, Privacy · Could have)</span>
